...
namespace ServiceLayer.BookServices
{
    public interface IBookService
    {
        ...
        Task<ApiResult<object>> GetBook(int page = 1, int size = 10, string orderBy = "Price", bool dsc = false, int? categoryId = null, string search = null);
        Task<ApiResult<object>> GetBookById(int id);
        // return id product
        Task<ApiResult<bool>> AddBook(BookRequest bookRequest);
        bool EditBook(BookRequest bookRequest);
