    ...
    public class BookService : IBookService
    {
        ...
        public async Task<ApiResult<bool>> AddBook(BookRequest bookRequest)
        {
            ...
            var book = new Book
            {
                ...
                Url = bookRequest.name.ConverToUrl()
            };
        ...
        public async Task<ApiResult<bool>> EditBook(int id, BookRequest bookRequest)
        {
            ...
            book.Url = bookRequest.name.ConverToUrl();
        ...
        public async Task<ApiResult<object>> GetBookByUrl(string url)
        {
            var book = await eShopDb.Books.FirstOrDefaultAsync(x => x.Url == url);
